...
parser.add_argument('-start', dest="DATE_START", type=int, default=1880, help="Start year")
...
parser.add_argument('-out', dest="OUTPUT_FILE", default="../../oversize-assets/giss/amap_%s.nc", help="Output dir")
