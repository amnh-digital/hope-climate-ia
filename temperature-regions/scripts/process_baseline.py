...
parser.add_argument('-ryears', dest="REF_YEARS", default="2017,2016,2015,2014,2013,2012,2011,2010", help="Reference years with correct baseline")
...
for t in range(len(baseTimes)):
    ...
    sys.stdout.write('\r')
    sys.stdout.write("%s%%" % round(1.0*(t+1)/len(baseTimes)*100,1))
    sys.stdout.flush()
dsout.close()
