...
function createWindow(browserWindowSetting, index) {
  ...
  mainWindow.on('unresponsive', function (e) {
    reload(mainWindow, appUrl, 'window unresponsive', e);
  });
  ...
  webContents.on('did-fail-load', function (e) {
    reload(mainWindow, appUrl, 'contents did-fail-load', e);
  });
  webContents.on('crashed', function (e) {
    reload(mainWindow, appUrl, 'contents crashed', e);
  });
  webContents.on('plugin-crashed', function (e) {
    reload(mainWindow, appUrl, 'contents plugin-crashed', e);
  });
  ...
  if (browserWindowSetting.bounds) {
    resize(mainWindow, browserWindowSetting.bounds, browserWindowSetting.resizeTimeout);
  }
